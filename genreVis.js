...
const vis1_2 = {
    ...
    description: "Total Views by Genre (Ranking)",
    transform: [
        {
            filter: "datum.categoryId == '24' || datum.categoryId == '20' || datum.categoryId == '10' || datum.categoryId == '27' || datum.categoryId == '17' || datum.categoryId == '25'"
        },
    ...
    encoding: {
        ...
        tooltip: [
            { field: "genre", type: "nominal" },
            { aggregate: "sum", field: "view_count", type: "quantitative", title: "Total Views" }
        ]
    }
}

vegaEmbed("#vis1", vis1);
vegaEmbed("#vis1_2", vis1_2);
...
async function loadRanking() {
  ...
  const selected = data.filter(d =>
    validCategories.includes(d.categoryId)
  );
